...
return e}const wv=vt({color:String,disableSort:Boolean,fixedHeader:Boolean,multiSort:Boolean,sortAscIcon:{type:Dt,default:"$sortAsc"},sortDescIcon:{type:Dt,default:"$sortDesc"},headerProps:{type:Object},sticky:Boolean,...Rl(),...To(),...cn()},"VDataTableHeaders"),kv=wt()({name:"VDataTableHeaders",props:wv(),setup(e,a){let{slots:l}=a
...
return{type:"item",key:e.returnObject?h(t,e.itemValue):n,index:a,value:n,selectable:o,columns:r,raw:t}}(e,t,l,a))}function Rv(e,a){return{items:t.computed(()=>Tv(e,e.items,a.value))}}const Bv=vt({...Ev(),hideDefaultBody:Boolean,hideDefaultFooter:Boolean,hideDefaultHeader:Boolean,width:[String,Number],search:String,...yd(),...kd(),...iv(),...Av(),...zd(),...Wd(),...I(wv(),["multiSort"]),..._v()},"DataTable"),Dv=vt({...Ad(),...Bv(),...ns(),...av()},"VDataTable"),Fv=wt()({name:"VDataTable",props:Dv(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
...
return e.landscape&&3===t.split(" ").length?t.replace(" ","\n"):t}),k=t.toRef(()=>o.parseISO(`${y.value}-${g.value+1}-01`)),S=t.toRef(()=>o.format(k.value,"monthAndYear")),x=t.toRef(()=>o.format(k.value,"monthShort")),N=t.toRef(()=>o.format(k.value,"year")),C=t.toRef(()=>`date-picker-header${V.value?"-reverse":""}-transition`),E=t.computed(()=>{if(e.disabled)return!0
const t=[]
...
if(a&&e in a)return a[e]}Hg.version="3.11.0"
const Ug=function(){return Hg({components:Dg,directives:jg,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},Gg="3.11.0"
